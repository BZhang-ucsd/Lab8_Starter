describe('Basic user flow for Website', () => {
  ...
  it('Initial Home Page - Check for 20 product items', async () => {
    ...
    // Expect that array from earlier to be of length 20, meaning 20 <product-item> elements were found
  ...
  it('Make sure <product-item> elements are populated', async () => {
    ...
    // Grab the .data property of the first <product-item> to grab all of the JSON data stored inside
